    ...
    return (
      <>
        ...
        <Dialog open={eulaAccept} maxWidth="lg" sx={{ zIndex: 3001 }}>
          <DialogTitle>
            เงื่อนไขและความยินยอมในการใช้งาน NM Story AI [อัปเดตเมื่อ 20 กันยายน
            2568]
          </DialogTitle>
          <DialogContent>
            ...
            <DialogContentText className="mb-3">
             ...
             <DialogContentText className="mb-3">
              4. ระบบไม่รองรับการสร้างรูปภาพหรือสื่อมีเดียใดๆ เนื่องจากข้อจำกัดทางด้านลิขสิทธิ์ที่อาจเกิดขึ้นได้ตามกฎหมาย
            </DialogContentText>
            <DialogContentText className="mb-3">
              5. หลีกเลี่ยงการเปิดเผยข้อมูลส่วนบุคคล ข้อมูลสำคัญ
            ...
            <DialogContentText className="mb-3">
              6. คุณสามารถส่งข้อความเพื่อสอบถามข้อมูลได้สูงสุด 5
              ข้อความต่อชั่วโมง ต่อ 1 อุปกรณ์ หลังจากนั้น
              ระบบจะบล็อคสิทธิ์การเข้าถึงชั่วคราวจนกว่าจะครบกำหนดเวลาที่ระบุ
            </DialogContentText>
            <DialogContentText className="mb-3">
              7. คุณสามารถเข้าใช้งานระบบได้เฉพาะในพื้นที่ประเทศไทยเท่านั้น
            </DialogContentText>
            <DialogContentText className="mb-3">
              8.
